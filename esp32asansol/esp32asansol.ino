...
void loop()
{
 ...
 tsLastReport = millis();
  ...
  server.send(200, "text/html", SendHTML( HR, SpO2, H, T, tempF)); 
}
...
void handle_NotFound(){
  ...
  String SendHTML(float HR,float SpO2, float T, float H,float tempF){
